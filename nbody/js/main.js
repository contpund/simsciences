// Bootstrap. Wires engine + renderer + controls + i18n into the page, then
// runs the requestAnimationFrame loop. Exposes window.__engine /
// window.__renderer / window.__driveFrame for the video-capture pipeline.

import { NBodyEngine } from './engine.js';
...
// Lightweight tooltip system mirroring ep03/ep04. Reads [data-tip] attributes
