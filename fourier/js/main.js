...
import { FourierEngine } from './engine.js';
...
// Lightweight tooltip system (mirrors ep03–ep07). Reads [data-tip] set by i18n.
(function tooltips() {
  let el = null;
...
// The readouts only move when a control moves; refreshing them every frame
